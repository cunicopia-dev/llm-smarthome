...
def text_to_speech_pico(text, output="speech.wav"):
    ...
    # Play the generated speech file using aplay (Linux) or any other audio playback command
...
def main():
    ...
    while True:
        ...
        if user_input.lower() == 'quit':
            print("Goodbye!")
            break
        base_response = generate_base_response(user_input, conversation_history, model=model, assistant_name=assistant_name)
